      ...
      <div className="container mx-auto flex flex-col-reverse md:flex-row items-center justify-between px-6 py-12 md:py-20">
        ...
        <div className="md:w-1/2 text-center md:text-left space-y-6 mt-10 md:mt-0">
          ...
          <div className="flex flex-col sm:flex-row justify-center md:justify-start gap-4">
            <button className="bg-red-700 text-white px-6 py-3 rounded-lg font-semibold hover:bg-red-800 transition w-full sm:w-auto">
              Shop Now
            </button>
            <button className="border border-red-700 text-red-700 px-6 py-3 rounded-lg font-semibold hover:bg-red-700 hover:text-white transition w-full sm:w-auto">
              Learn More
            </button>
          </div>
        </div>
